...
static const std::string bg_portrait = "textures/bg_portrait.jpg";
static const std::string bg_landscape = "textures/bg_landscape.jpg";

static const std::string bg_res_repeating = "bg_fix";
static const std::string bg_res_portrait = "bg_portrait";
static const std::string bg_res_landscape = "bg_landscape";
...
void StartWorldUi::updateBackground()
{
...
void StartWorldUi::updateSize(const math::size& newSize)
{
...
void StartWorldUi::setEnabled(bool value) {
  WorldUi::setEnabled(value);
  W4_LOG_DEBUG("StartWorldUiENABLED CHANGED TO %d",  value);
}

void StartWorldUi::initContent()
{
